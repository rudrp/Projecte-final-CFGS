...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US" xml:lang="en">
    <head>
        ...
        <!--[if IE 6]><link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/style.ie6.css" type="text/css" media="screen" /><![endif]-->
        <!--[if IE 7]><link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/css/style.ie7.css" type="text/css" media="screen" /><![endif]-->

        <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/css/jquery.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/css/script.js"></script>
    </head>
	<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"[]>
    <body>
        ...
        <div id="art-main">
			 ...
			 //'activeCssClass'	=> 'current',
                         'items'=>array(
                          ...
                          array('label'=>'About', 'url'=>array('/site/page', 'view'=>'about') ),
                          array('label'=>'Contact', 'url'=>array('/site/contact') ),
                          array('label'=>'Ranking', 'url'=>array('/ranking/index') ),
                          //array('label'=>'Jugar', 'url'=>array('/joc/index') ),
                          array('label'=>'Jugar', 'url'=>array('/joc/index'),'visible'=>!Yii::app()->user->isGuest ),
                          array('label'=>'Administrar usuaris','url'=>Yii::app()->user->ui->userManagementAdminUrl,'visible'=>!Yii::app()->user->isGuest ),
						...
						<div class="art-footer">
							<div class="art-footer-body">
								<div class="art-footer-text">
									...
									<p style="text-align: right;"><a href="#"><img width="32" height="32" alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/css/images/rss_32-2.png" style="margin-right:10px;" /></a><a href="#"><img width="32" height="32" alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/css/images/twitter_32-2.png" style="margin-right: 10px; cursor: text;" /></a><a href="#"><img width="32" height="32" alt="" src="<?php echo Yii::app()->request->baseUrl; ?>/css/images/facebook_32-2.png" /></a></p><br />
									<br />
