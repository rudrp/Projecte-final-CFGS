    ...
    $('#send').on('submit', function(e){
      ...
      eachActiveConnection(function(c, $c) {
       if (c.label === 'Joc_connection') {
          ...
          //el master s'encarrega d'enviar dades les coordenades
          if(master==true){
...
/**************************************************************************************/
  ...
  function setUpGame() {
    ...
    //gameCanvas.style.backgroundImage = 'url(../img/bckk2.gif)';
...
function dibujarexplosive(x) {
        var contador=0;
        var pixels =[100,100,100,100,100,100,100,100,100,100];
        increment=0;
        explosion= new Image();
        explosion.src="../img/d.png";   
      
        gameCanvas.getContext("2d").drawImage(explosion,increment,0,120,120,x,5,50,50);
        increment+=120;
        contador=contador+1;
  ...
  function handleTick(enemyXPositions,enemyYPositions,num_enemies,avatarX,avatarY,avatar2x,avatar2y)
   {
      ...
      //tempCtx.drawImage(img_avatar, avatarX, avatarY);
      ...
      while (current_enemies < num_enemies) {
        ...
        if ( ( (avatarX < enemyXPositions[current_enemies] && enemyXPositions[current_enemies] < avatarX + 32) || (enemyXPositions[current_enemies] < avatarX && avatarX < enemyXPositions[current_enemies] + 32) ) && ( (avatarY < enemyYPositions[current_enemies] && enemyYPositions[current_enemies] < avatarY + 32) || (enemyYPositions[current_enemies] < avatarY && avatarY < enemyYPositions[current_enemies] + 32) ) ) {
           // setInterval(dibujarexplosive(enemyXPositions[current_enemies]), 35);
            //array_numeros.splice(idx, 1);
            console.log(enemyXPositions.length);
            delete enemyXPositions[current_enemies];
            delete enemyYPositions[current_enemies];
            console.log(enemyXPositions.length);
          //vides_master=vides_master-1;
