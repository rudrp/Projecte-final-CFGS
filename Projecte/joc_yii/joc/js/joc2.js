...
/**************************************************************************************/
    ...
    function eachActiveConnection(fn) {
     ...
     // var peerId = $(this).attr('id');//original
     // var peerId = $('#pid').text(id);
  ...
  function handleTick(enemyXPositions,enemyYPositions,num_enemies,avatarX,avatarY,avatar2x,avatar2y)
   {
      ...
      if(vides_master<=0){
        console.log("master mort");
      } 
      if(vides_esclau<=0){
        console.log("esclau mort")

      }
      if(vides_esclau>vides_master){
          console.log("guanya esclau");
          guanyador="esclau";


      }else{
        console.log("guanya master");
        guanyador="master";
      }
  }
