			 ...
			 $this->widget('zii.widgets.CMenu',array(
                    ...
                    'encodeLabel'=>false,
                        'items'=>array(
                          ...
                          array('label'=>'Sobre nosaltres', 'url'=>array('/site/page', 'view'=>'about'),'linkOptions' => array( 'class' => 'menulink' ) ),
                          array('label'=>'Contacte', 'url'=>array('/site/contact'),'linkOptions' => array( 'class' => 'menulink' ) ),
                          array('label'=>'Rànquing', 'url'=>array('/ranking/index'),'linkOptions' => array( 'class' => 'menulink' ) ),
                          ...
                          array('label'=>'Administrar Usuaris','url'=>Yii::app()->user->ui->userManagementAdminUrl,'visible'=>Yii::app()->user->isSuperAdmin,'linkOptions' => array( 'class' => 'menulink' ) ),
