    <div class=" shout-box">
        <div class="shout-text">
          ...
          <p>lalalalal<br> All our themes are responsive and look great on any device.</p>
        </div> 
    </div>
            ...
            <ul class="thumbnails center">
              ...
              <li class="span3">
                <div class="thumbnail">
                  ...
                  <p>Use this document as adddd way to quick start any new project.<br> All you get is this message and a barebones HTML document.</p>
                </div>
              </li>
